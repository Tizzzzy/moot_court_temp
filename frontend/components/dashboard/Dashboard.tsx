import svgPaths from "@/imports/svg-jaqtqh9gg5";
                ...
                <>
                  <div className="mb-4">
                    <p className="text-[14px] text-[#64748b]">
                      {readyCount} of {totalCategories} categories have evidence • {totalFilesUploaded} file{totalFilesUploaded !== 1 ? "s" : ""} uploaded
                    </p>
                              ...
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                {status === "ready" && (
                                  <div className="bg-[#dcfce7] border border-[#b9f8cf] h-[22px] px-[5px] py-px rounded-[8px] flex items-center gap-2">
                                    ...
                                    <p className="font-['Inter:Medium',sans-serif] font-medium text-[12px] text-[#016630]">
                                      Ready to use
                                    </p>
                                  </div>
                                )}
                                {status === "needs-improvement" && (
                                  <div className="bg-[#fef9c2] border border-[#ac7f5e] h-[22px] px-[5px] py-px rounded-[8px] flex items-center gap-2">
                                    ...
                                    <p className="font-['Inter:Medium',sans-serif] font-medium text-[12px] text-[#ac7f5e]">
                                      Need improvement
                                    </p>
                                  </div>
                                )}
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-[14px] text-[#62748e] tracking-[-0.3125px]">
                      Please upload any evidence you believe could be helpful. This may include
                      documents, images, or any other relevant materials that support your case.
                    </p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[12px] text-[#64748b] mb-1">
                      Please provide your basic information so we can understand your situation
                      better.
                    </p>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    {readyCount === totalCategories && (
                      <button className="mt-2 bg-white border border-[rgba(0,0,0,0.1)] h-[32px] px-4 rounded-lg text-[14px] text-[#0a0a0a] font-medium hover:bg-gray-50 transition-colors">
                        Start
                      </button>
                    )}
                  </div>
